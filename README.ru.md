...
> – **Release** — оптимизированная, консоль скрыта, символы удалены,<br>
> – **Debug** — видимое консольное окно с выводом логов в реальном времени (`-DDEBUG_LOG`) и расширенной трассировкой DDE-сообщений.<br>
