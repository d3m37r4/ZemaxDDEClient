...
- [**Релизные сборки**](https://github.com/d3m37r4/ZemaxDDEClient/releases) — стабильные, протестированные версии для основного использования.<br>
...
> 💡 Каждый тип сборки содержит два варианта:<br>
> – **Release** — полностью оптимизированная (LTO), консоль скрыта, символы удалены. Готова к основному использованию,<br>
> – **Debug** — оптимизированная для отладки (`-Og`), видимая консоль с выводом логов в реальном времени (`-DDEBUG_LOG`) и расширенной трассировкой DDE-сообщений.<br>
> Оба варианта имеют одинаковый номер билда для удобства сопоставления.
...
3. В окне **DDE Status** нажмите кнопку **Connect to Zemax**
4. Выберите окно Zemax из списка и нажмите **Connect**

## 📦 Требования
- **MSYS2** с набором инструментов MinGW-w64 (включая **Ninja**)  
- **CMake** (версия ≥ 3.16)  
